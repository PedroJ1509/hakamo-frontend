...
interface StrokeTextProps {
  ...
  reverse?: boolean
  /** Segundos de espera antes de empezar a dibujar. */
  delay?: number
  className?: string
  style?: CSSProperties
}
...
export default function StrokeText({
  ...
  useEffect(() => {
    ...
    const build = () => {
      ...
      // La espera se aplica como posición en la línea de tiempo: así funciona
      // igual aunque la timeline esté pausada y se reproduzca a mano.
      tl.to(strokes, { strokeDashoffset: 0, duration: drawDuration, ease, stagger: staggerConfig }, delay)
  ...
  return (
    ...
    >
      {/* height:auto + viewBox = escala proporcional al ancho del contenedor */}
      <svg
