      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <ul className="space-y-2.5">
              {NAVEGAR.map((link) => (
                <li key={link.href}>
                  ...
                  >
                    <span className="w-1 h-1 rounded-full bg-white/30 group-hover:bg-white/70 transition-colors flex-shrink-0" />
                    {link.label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <Link
              href="/contacto"
              className="inline-flex items-center gap-2 mt-6 px-5 py-2.5 rounded-lg text-sm font-semibold bg-white/12 hover:bg-white/20 transition-colors"
            >
              Escríbenos →
            </Link>
          </div>
